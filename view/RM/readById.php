                                ...
                                <div class="col-md-12">
                                    <div class="panel">
                                        <div class="col-md-12 panel-heading">
                                            <h4><?php
                                                if ($obj == null) {
                                                    echo $error[] = "Pasien " . $odaftar->data->nama . " tidak memiliki rekam medis";
                                                } else {
                                                    echo "Rekam medis pasien : " . $odaftar->data->nama;
                                                }
                                                ?></h4>
