                                                        ...
                                                        <table style="font-size:14px" width="100%">									
                                                            <tbody>
                                                                ...
                                                                <tr valign="top" height="21px">
                                                                    <td >Umur</td>
                                                                    <td >:</td>
                                                                    <td ><div class="form-group"><input type="text" name="umur" class="form-control android" value="<?php
                                                                            $today = date("Y-m-d");
                                                                            $diff = date_diff(date_create($obj->data->tgl_lahir), date_create($today));
                                                                            echo $umur = $diff->format('%y');
                                                                            ?>" readonly></div></td>
                                                                </tr>	
                                                                <tr valign="top" height="21px">
                                                                    <td >Alamat</td>
                                                                ...
                                                                <tr valign="top" height="21px">
                                                                    <td>Nama Dokter</td>
                                                                    <td>:</td>														
                                                                    <td><div class="form-group"><input type="text" name="nama_dr" class="form-control android" required></div></td>
                                                                </tr>
                                                            </tbody>
                                                        </table> 
                                                    </div>
                                                            ...
                                                            <tbody>												
                                                                ...
                                                                <tr valign="top" height="21px">
                                                                    ...
                                                                    <td><div class="form-group">
                                                                            <input type="date" name="mrs" class="form-control android" required>
                                                                        </div></td>
                                                                </tr>
                                                                <tr valign="top" height="21px">
                                                                    <td>Jam</td>
                                                                    <td>:</td>
                                                                    <td><div class="form-group">
                                                                            <input type="time" name="jam" class="form-control android" required>
                                                                        </div></td>
                                                                </tr>												
                                                                <tr valign="top" height="21px">
                                                                    ...
                                                                    <td>:</td>
                                                                    <td><div class="form-group">
                                                                            <input type="text" name="nama_rs" class="form-control android" required>
                                                                        </div></td>
                                                                </tr>
                                                                <tr valign="top" height="21px">
                                                                    <td>Ruang</td>
                                                                    <td>:</td>
                                                                    <td><div class="form-group">
                                                                            <input type="text" name="ruang" class="form-control android" required></div>
                                                                    </td>
                                                                </tr>													
                                                                <tr valign="top" height="21px">
                                                                    <td>Poli</td>
                                                                    <td>:</td>
                                                                    <td><div class="form-group">
                                                                            <input type="text" name="poli" class="form-control android" required></div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <table class="table table-condensed">
                                                        ...
                                                        <tbody>
                                                            <tr valign="top" height="20px">
                                                                ...
                                                                <td width="1%">:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="anamnesa" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="riwayat_penyakit" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>
                                                            <tr >
                                                                ...
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="riwayat_pekerjaan" class="form-control android" value="<?php echo $obj->data->pekerjaan; ?>" required>
                                                                    </div></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="riwayat_alergi" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table class="table table-condensed">
                                                        ...
                                                        <tbody>
                                                            <tr valign="top" height="21px">
                                                                ...
                                                                <td width="1%">:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="keadaan_umum" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>
                                                            <tr valign="top" height="21px">
                                                                <td>Kesadaran</td>
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="kesadaran" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>											
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table class="table table-condensed">
                                                        ...
                                                        <tbody>
                                                            <tr valign="top" height="21px">
                                                                ...
                                                                <td width="1%">:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="E" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>
                                                            <tr valign="top" height="21px">
                                                                <td>Verbal</td>
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="V" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>
                                                            <tr valign="top" height="21px">
                                                                <td>Motor</td>
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="M" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table class="table table-condensed">
                                                        ...
                                                        <tbody>
                                                            <tr valign="top" height="21px">
                                                                ...
                                                                <td width="1%">:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="suhu" class="form-control android" required>
                                                                    </div></td>
                                                                <td> &#176; C</td>
                                                            </tr>
                                                            <tr valign="top" height="21px">
                                                                ...
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="respirasi" class="form-control android" required>
                                                                    </div></td>
                                                                <td> &#215;/menit</td>
                                                            </tr>
                                                            <tr valign="top" height="21px">
                                                                ...
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="nadi" class="form-control android" required>
                                                                    </div></td>
                                                                <td > &#215;/menit</td>
                                                            </tr>
                                                            <tr valign="top" height="21px">
                                                                ...
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="TD" class="form-control android" required>
                                                                    </div></td>
                                                                <td > mmHg</td>
                                                            </tr>
                                                        </tbody>
                                                    ...
                                                    <table class="table table-condensed">
                                                        <tbody>
                                                            <tr valign="top" height="21px">
                                                                ...
                                                                <td width="1%">:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="pemeriksaan" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>
                                                            <tr valign="top" height="21px">
                                                                <td>Penunjang</td>
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="penunjang" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>
                                                            <tr valign="top" height="21px">
                                                                ...
                                                                <td width="1%">:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="diagnosa_kerja" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>
                                                            <tr valign="top" height="21px">
                                                                ...
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="diagnosa_banding" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>	
                                                            <tr valign="top" height="21px">
                                                                <td>Pelayanan</td>
                                                                <td>:</td>
                                                                <td><div class="form-group">
                                                                        <input type="text" name="pelayanan" class="form-control android" required>
                                                                    </div></td>
                                                            </tr>										
                                                        </tbody>
                                                    </table>
